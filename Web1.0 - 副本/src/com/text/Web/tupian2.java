...
public class tupian2 extends HttpServlet {
	...
	protected void doGet(HttpServletRequest req, HttpServletResponse resp)
	     ...
	     try {
			...
			su.upload();
			int count = su.save(file.getPath());
...
//			 System.out.println("上传文件成功");
	     ...
	     req.getSession().setAttribute("fliesss","images/"+su.getFiles().getFile(0).getFileName());
	     System.out.println("aaa  :"+req.getSession().getAttribute("fliesss"));
